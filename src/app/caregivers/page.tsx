    ...
    <div>
      ...
      <form className="mt-6 flex flex-wrap gap-3" method="get">
        <input
          ...
          defaultValue={city}
          placeholder="City"
          className="rounded-full border border-[var(--color-line)] bg-[var(--color-surface)] px-4 py-2 text-sm transition placeholder:text-[var(--color-muted)]/60 focus:border-[var(--color-accent)] focus:outline-none"
        />
        <input
          name="spec"
          defaultValue={spec}
